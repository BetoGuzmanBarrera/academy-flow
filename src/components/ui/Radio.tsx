...
export const Radio = forwardRef<HTMLInputElement, RadioProps>(function Radio(
  ...
  return (
    <div>
      <label htmlFor={radioId} className="flex min-h-touch cursor-pointer items-start gap-3 py-2 text-academy-text">
        <input
          ref={ref}
          id={radioId}
          type="radio"
          ...
          className={classNames(
            'mt-0.5 h-5 w-5 shrink-0 border-academy-border text-academy-primary',
